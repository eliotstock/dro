...
describe('Token ratio by value', function () {
    it('Should be close to 1.0 for some specific values', async function() {
        ...
        // Test division of two large integers to get a float.
        // const a: bigint = 107848000000000000n
        // const b: bigint = 392600000000000000n
        // const c: number = Number(a * 100n / b) / 100
